...
public class WordFrequencyMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    /**
     * Parameter key is the byte offset of the current line in the file;
     * Parameter value is the line from the file
     * Parameter output has the method "collect()" to output the key,value pair
     * Parameter reporter allows us to retrieve some information about the job (like the current filename)
     *
